...
Student: 23/631/BARC-S

## Program
My notebook, 23_631__BARC-S_W02.ipynb, sets my student ID and cohort, prints a hello message and works out proof_sum (2 + 2 = 4). It adds 5 to readings each time a cell runs. It then reads the four records from site_inspection_log.csv into rows.

## File list
- 23_631_BARC-S_W02.ipynb: my completed notebook, saved with outputs showing
